 ...
 * <p>원본 토픽(order.created/payment.completed/payment.failed/order.cancelled) 및 발행 토픽
 * (product.updated/stock.reservation.result)·DLQ 토픽 생성은 전환기 root(Order/Payment) 가 소유한다.
