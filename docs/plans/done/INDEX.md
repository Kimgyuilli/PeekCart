...
계획서 61개. 진행 중인 계획서는 `docs/plans/` 루트에 있다.
...
| [task-d032-integration-test-container-singleton](./task-d032-integration-test-container-singleton.md) | D-032 — 통합 테스트 컨테이너 모듈 싱글톤 전환 (order-service) | [#138](https://github.com/Kimgyuilli/PeakCart/pull/138) | 2026-09-24 | 있음 |
...
| [task-d035-product-container-singleton](./task-d035-product-container-singleton.md) | task-d035-product-container-singleton | [#147](https://github.com/Kimgyuilli/PeakCart/pull/147) | 2026-09-27 | 있음 |
